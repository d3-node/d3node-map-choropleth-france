...
const csvString = fs.readFileSync('data/fr-population.csv').toString();
const population = d3.csv.parse(csvString);

// adapted from: https://bl.ocks.org/bricedev/97c53d6ed168902239f7
var options = {
  svgStyles:'svg{font: 10px sans-serif;}.border{stroke-width:.3px;fill:none;stroke:#333;}.caption{font-weight: bold;}.key path {display: none;}.key line{stroke:#000;shape-rendering:crispEdges;}',
  d3Module: d3
};
...
// create output files
output('dist/map-choropleth', d3n);
